...
Ext.define('AppIndex.controller.base.UserManagerController',{
    extend:'Ext.app.ViewController',
    alias:'controller.user_manager_view',
    requires:[
        'AppIndex.view.base.UserManagerViewWindowAdd',
        'AppIndex.view.base.UserManagerViewWindowEdit'
    ],
    control:{},
    routes:{},
    ...
    onClickAdd : function () {
        ...
        this.loadGrid();
        Ext.create('AppIndex.store.base.GetUserInfoNewIdStore').load({
            scope:this,
            callback: function (records, operation, success) {
    ...
    onClickEdit : function () {
        ...
        winForm.findField('role_name').setValue(record[0].data['role_id']);
