...
Ext.define('AppIndex.controller.RepositoryInfoController',{
    ...
    requires:[
        'AppIndex.view.RepositoryInfoAddWin',
        'AppIndex.view.RepositoryInfoEditWin'
    ],
    control:{},
    routes:{},
    ...
    onClickAdd : function () {
        ...
        mWinRepositoryInfo = Ext.create({
            xtype: 'app_repository_info_add_win'
        });
    ...
    onClickEdit : function () {
        ...
        this.closeWin();
        mWinRepositoryInfo = Ext.create({
            xtype: 'app_repository_info_edit_win'
        });

        var winForm = mWinRepositoryInfo.down('form').getForm();
        winForm.findField('repository_id').setValue(record[0].data['repository_id']);
        winForm.findField('repository_type').setValue(record[0].data['repository_type']);
    ...
    onClickAddSave : function () {
        ...
        var sendParam= {
            ...
            repository_type: winFormData['repository_type'],
