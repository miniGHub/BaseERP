Ext.define('AppIndex.controller.dic.DepartDicController',{
    extend:'Ext.app.ViewController',
    alias:'controller.depart_dic_view',
    requires:[],
    control:{},
    routes:{},
    ...
    onClickAdd : function () {
        ...
        var grid = this.getView().down('app_depart_dic_view_grid');
    ...
    onClickSave : function () {
        ...
        // grid data
        var store = this.getView().down('app_depart_dic_view_grid').getStore();
        var gridData = [];
        Ext.each(store.getRange(0, store.getCount()), function(record) {
        ...
        sendStore.load({
            ...
            callback: function (records, operation, success) {
                ...
                if (ret) {
                    // transfer success
                    this.departDicCallback(records, operation);
                } else {
    ...
    departDicCallback: function (records, operation) {
